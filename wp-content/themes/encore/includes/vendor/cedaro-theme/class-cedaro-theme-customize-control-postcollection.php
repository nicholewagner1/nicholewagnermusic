...
class Cedaro_Theme_Customize_Control_PostCollection extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->labels = wp_parse_args( $this->labels, array(
			'addPost'                => esc_html__( 'Add Post', 'encore' ),
			'addPosts'               => esc_html__( 'Add Posts', 'encore' ),
			'clearResults'           => esc_html__( 'Clear Results', 'encore' ),
			'featuredImage'          => esc_html__( 'Featured Image', 'encore' ),
			'remove'                 => esc_html__( 'Remove', 'encore' ),
			'removePost'             => esc_html__( 'Remove Post', 'encore' ),
			'setFeaturedImage'       => esc_html__( 'Set Featured Image', 'encore' ),
			'togglePost'             => esc_html__( 'Toggle Post', 'encore' ),
			'searchPosts'            => esc_html__( 'Search Posts', 'encore' ),
			'searchPostsPlaceholder' => esc_html__( 'Search posts&hellip;', 'encore' ),
		) );
	}
