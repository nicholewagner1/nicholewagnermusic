...
class Cedaro_Theme_Archive_Feature_Content extends Cedaro_Theme_Archive_Feature {
	...
	public function add_support( $options = array() ) {
		if ( empty( $options ) ) {
			$options = array(
				'full-text'       => esc_html__( 'Full Text', 'wayfarer' ),
				'summary'         => esc_html__( 'Summary', 'wayfarer' ),
				'custom-excerpts' => esc_html__( 'Custom Excerpts', 'wayfarer' ),
				'none'            => esc_html__( 'No Content', 'wayfarer' ),
			);
		}
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control( 'cedaro_archive_content_mode', array(
			'label'    => esc_html__( 'Archive Content', 'wayfarer' ),
