...
class Cedaro_Theme_Customize_Control_PostCollection extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->labels = wp_parse_args( $this->labels, array(
			'addPost'                => esc_html__( 'Add Post', 'wayfarer' ),
			'addPosts'               => esc_html__( 'Add Posts', 'wayfarer' ),
			'clearResults'           => esc_html__( 'Clear Results', 'wayfarer' ),
			'featuredImage'          => esc_html__( 'Featured Image', 'wayfarer' ),
			'remove'                 => esc_html__( 'Remove', 'wayfarer' ),
			'removePost'             => esc_html__( 'Remove Post', 'wayfarer' ),
			'setFeaturedImage'       => esc_html__( 'Set Featured Image', 'wayfarer' ),
			'togglePost'             => esc_html__( 'Toggle Post', 'wayfarer' ),
			'searchPosts'            => esc_html__( 'Search Posts', 'wayfarer' ),
			'searchPostsPlaceholder' => esc_html__( 'Search posts&hellip;', 'wayfarer' ),
		) );
	}
