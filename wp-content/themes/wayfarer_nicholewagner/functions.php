<? 
add_filter( 'wayfarer_hero_background_image', function( $image ) {
	
		//if ( is_home() ) {
	//	$image = 'https://www.nicholewagnermusic.com/wp-content/uploads/header_dancesongs.jpg';
//make sure to remove css rules for home hero when reinstating	}
if ( is_archive() ){
		$image = 'https://www.nicholewagnermusic.com/wp-content/themes/wayfarer_nicholewagner/headers/nicholewagner_header_centralmachine.jpg';
	}

	if ( empty( $image ) || is_category()  ) {
		$image = 'https://www.nicholewagnermusic.com/wp-content/themes/wayfarer_nicholewagner/headers/nicholewagner_header_centralmachine.jpg';
	}
	return $image;
}, 10, 2 );
