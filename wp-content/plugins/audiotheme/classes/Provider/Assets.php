...
class AudioTheme_Provider_Assets extends AudioTheme_AbstractProvider {
	...
	public function register_assets() {
		...
		if ( ! wp_script_is( 'moment', 'registered' ) ) {
			wp_register_script( 'moment', $base_url .'/vendor/moment.min.js', array(), '2.23.0', true );
		}
		...
		wp_register_script( 'pikaday',                 $base_url .'/vendor/pikaday.min.js',            array( 'moment'),                                      '1.8.0',  true );
